...
{
    return tempPath() + "safechecker-openvpn.log";
}

QString PathHelper::openvpnConfigFilename()
{
    return tempPath() + "safechecker-openvpn.ovpn";
}
...
#else
#ifdef Q_OS_LINUX
    return "/opt/safechecker/env/bin/obfsproxy";
#else		// Win
...
{
    return tempPath() + "safechecker-obfsproxy.log";
}
